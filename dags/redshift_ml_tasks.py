...
def fetch_data_from_redshift():
    ...
    products_query = """ SELECT * FROM otto."29cm_product" UNION SELECT * FROM otto.musinsa_product """
    reviews_query = """ SELECT * FROM otto."29cm_reviews" UNION SELECT * FROM otto.musinsa_reviews """
